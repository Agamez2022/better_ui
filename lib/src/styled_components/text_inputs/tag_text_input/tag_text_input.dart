...
class BetterTagTextInput extends StatefulWidget {
  ...
  @override
  BetterTagTextInputState createState() => BetterTagTextInputState();
}

class BetterTagTextInputState extends State<BetterTagTextInput> {
