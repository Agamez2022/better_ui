...
/// [BetterExpansionTile] to save and restore its expanded state when it is scrolled
/// in and out of view.
///
/// See also:
///
...
class BetterExpansionTile extends StatefulWidget {
  ...
  @override
  BetterExpansionTileState createState() => BetterExpansionTileState();
}

class BetterExpansionTileState extends State<BetterExpansionTile>
    ...
    return Container(
      ...
      decoration: widget.decoration ??
          BoxDecoration(
            ...
            border: const Border(
              top: BorderSide(color: BetterColors.transparent),
              bottom: BorderSide(color: BetterColors.transparent),
            ),
          ),
      child: Column(
