...
class BetterPrimaryButton extends StatefulWidget {
  const BetterPrimaryButton({
    Key? key,
    this.prefixIcon,
    this.suffixIcon,
    this.buttonText,
  ...
  _BetterPrimaryButtonState createState() => _BetterPrimaryButtonState();
...
class _BetterPrimaryButtonState extends State<BetterPrimaryButton>
  ...
  @override
  void didUpdateWidget(BetterPrimaryButton old) {
            ...
            child: DecoratedBox(
              ...
              child: Container(
                ...
                padding: widget.padding ??
                    ((![BetterColors.transparent, null].contains(widget.color))
                        ? _kButtonPadding
                        : _kBackgroundButtonPadding),
                child: (![BetterColors.transparent, null]
